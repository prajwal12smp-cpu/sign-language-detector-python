...
Limitations: Supports only static gestures (no motion-based signs), limited to 14 predefined classes. Single-hand detection only, the authentication system is currently a placeholder
